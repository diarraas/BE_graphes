...
public class Performances {
    ...
    public static void initAll() throws IOException {
        ...
        */
    	...
    	origin = 5669 ;
    	destination =  5185;
    	for(i=150; i < 250;i++) { //50 next couples of nodes on Toulouse map
    	...
    	origin = 14737 ;
    	destination =  8182;
    	for(i=200; i < 250;i++) { //50 last couples of nodes on Bordeaux map
    	...
    	origin = 5669 ;
    	destination =  5185;
    	for(i=250; i < 300;i++) { //50 next couples of nodes on Toulouse map
	...
	public static void launchTestDijkstraDistance() throws IOException{
		...
		int i ;
		PrintWriter small = new PrintWriter(new FileWriter("chile_distance_dijkstra_50_data.txt"));
		PrintWriter average = new PrintWriter(new FileWriter("belgium_distance_dijkstra_50_data.txt"));
		PrintWriter big = new PrintWriter(new FileWriter("california_distance_dijkstra_50_data.txt"));
		PrintWriter cars = new PrintWriter(new FileWriter("toulouse_distance_dijkstra_50_data.txt"));
		PrintWriter no_car = new PrintWriter(new FileWriter("bordeaux_distance_dijkstra_50_data.txt"));
	...
	public static void launchTestAstarDistance() throws IOException{
		ShortestPathSolution[] solutions = new ShortestPathSolution[100]; 
		int i ;
		PrintWriter small = new PrintWriter(new FileWriter("chile_distance_astar_50_data.txt"));
		PrintWriter average = new PrintWriter(new FileWriter("belgium_distance_astar_50_data.txt"));
		PrintWriter big = new PrintWriter(new FileWriter("california_distance_astar_50_data.txt"));
		PrintWriter cars = new PrintWriter(new FileWriter("toulouse_distance_astar_50_data.txt"));
		PrintWriter no_car = new PrintWriter(new FileWriter("bordeaux_distance_astar_50_data.txt"));
		small.println("chile"); average.println("Belgium"); big.println("California"); cars.println("Toulouse");no_car.println("Bordeaux");
		small.println("0 \n 50 \n A*"); average.println("0 \n 50 \n A*"); big.println("0 \n 50 \n A*"); cars.println("0 \n 50 \n A*");no_car.println("0 \n 50 \n A*");
		for(i = 0; i < 50; i++) {
	...
	public static void launchTestDijkstraTime() throws IOException{
		ShortestPathSolution[] solutions = new ShortestPathSolution[100];
		int i ;
		PrintWriter small = new PrintWriter(new FileWriter("chile_temps_dijkstra_50_data.txt"));
		PrintWriter average = new PrintWriter(new FileWriter("belgium_temps_dijkstra_50_data.txt"));
		PrintWriter big = new PrintWriter(new FileWriter("california_temps_dijkstra_50_data.txt"));
		PrintWriter cars = new PrintWriter(new FileWriter("toulouse_temps_dijkstra_50_data.txt"));
		PrintWriter no_car = new PrintWriter(new FileWriter("bordeaux_temps_dijkstra_50_data.txt"));
		small.println("Chile"); average.println("Belgium"); big.println("California"); cars.println("Toulouse");no_car.println("Bordeaux");
	...
	public static void launchTestAstarTime() throws IOException{
		ShortestPathSolution[] solutions = new ShortestPathSolution[100];
		int i ;
		PrintWriter small = new PrintWriter(new FileWriter("chile_temps_astar_50_data.txt"));
		PrintWriter average = new PrintWriter(new FileWriter("belgium_temps_astar_50_data.txt"));
		PrintWriter big = new PrintWriter(new FileWriter("california_temps_astar_50_data.txt"));
		PrintWriter cars = new PrintWriter(new FileWriter("toulouse_temps_astar_50_data.txt"));
		PrintWriter no_car = new PrintWriter(new FileWriter("bordeaux_temps_astar_50_data.txt"));
		small.println("Chile"); average.println("Belgium"); big.println("California"); cars.println("Toulouse");no_car.println("Bordeaux");
		small.println("1 \n 50 \n A*"); average.println("1 \n 50 \n A*"); big.println("0 \n 50 \n A*"); cars.println("0 \n 50 \n A*");no_car.println("0 \n 50 \n A*");
		for(i = 0; i < 50; i++) {
			solutions[i] = astar[i].doRun();
